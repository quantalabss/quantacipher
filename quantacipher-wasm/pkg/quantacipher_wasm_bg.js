 ...
 * @returns {string}
 */
export function encrypt_local_kyber(plaintext) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function get_wasm_version() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function secure_decrypt(ciphertext_payload, private_key_b64) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function secure_encrypt(plaintext, public_key_b64) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(plaintext, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function vault_encrypt(plaintext) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(plaintext, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
