...
NIST ML-KEM (Kyber-1024) · AES-256-GCM · KEM/DEM Hybrid · Dual-Mode Architecture</p>
...
- **KEM layer:** NIST ML-KEM (Kyber-1024, FIPS 203) — establishes a post-quantum shared secret
...
- **WebAssembly** via `wasm-bindgen` → [`quantacipher-wasm`](https://www.npmjs.com/package/quantacipher-wasm) on npm
...
Generates a Kyber-1024 keypair. Returns `(public_key_b64, private_key_b64)` — both are base64-encoded.
...
| Kyber Ciphertext Size | 1568 bytes |
...
```
QZ_VAULT_V1  : <base64 Kyber-1024 CT> : <base64 12-byte AES nonce> : <base64 AES-256-GCM CT>
QZ_SECURE_V1 : <base64 Kyber-1024 CT> : <base64 12-byte AES nonce> : <base64 AES-256-GCM CT>
```
...
```toml
pqc_kyber = "0.7.1"   # Kyber-1024 KEM
aes-gcm   = "0.10"    # AES-256-GCM AEAD
base64    = "0.21"    # Payload encoding
rand      = "0.8"     # OS RNG
```
