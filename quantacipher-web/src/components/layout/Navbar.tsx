...
export function Navbar() {
    ...
    return (
        <nav className="fixed w-full z-50 bg-white border-b border-[#dadce0]">
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
                <div className="flex justify-between items-center h-[64px]">
                    <div className="flex-shrink-0 flex items-center gap-2">
                        <Link href="/" className="flex items-center gap-2 group">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-[24px] font-bold text-[#202124] tracking-tighter group-hover:text-[#1a73e8] transition-colors relative top-[-1px]">
                                    QuantaCipher
                                </span>
                            </div>
                        </Link>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        <Link href="/demo" className="text-[#5f6368] hover:text-[#202124] hover:no-underline transition-colors text-[14px] font-medium tracking-wide">View demo</Link>
            ...
            {isOpen && (
                <div className="md:hidden bg-white border-b border-[#dadce0] shadow-lg">
                    <div className="px-6 py-6 space-y-4">
                        <Link href="/demo" onClick={() => setIsOpen(false)} className="block text-[#202124] font-medium text-[16px]">View demo</Link>
