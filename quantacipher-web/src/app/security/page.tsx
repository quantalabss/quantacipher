        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-24 pb-16">
                <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-[48px] font-normal text-[#202124] mb-4">Security Overview</h1>
                        <p className="text-[14px] text-[#5f6368] mb-12">Transparency in our post-quantum cryptographic infrastructure.</p>

                        <div className="prose prose-lg max-w-none">
                            <p className="text-[18px] text-[#5f6368] leading-relaxed mb-12">
                            ...
                            <div className="grid gap-8 mb-16">
                                {/* Card 1 */}
                                <div className="bg-[#f8f9fa] p-6 rounded-[12px] border border-[#dadce0]">
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="bg-[#e8f0fe] p-2 rounded-full">
                                            <Shield className="w-6 h-6 text-[#1a73e8]" />
                                        </div>
                                        <h3 className="text-[20px] font-medium text-[#202124] m-0">NIST Kyber-1024 Implementation</h3>
                                    </div>
                                    <p className="text-[15px] text-[#5f6368] leading-relaxed m-0">
                                ...
                                <div className="bg-[#f8f9fa] p-6 rounded-[12px] border border-[#dadce0]">
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="bg-[#e8f0fe] p-2 rounded-full">
                                            <Server className="w-6 h-6 text-[#1a73e8]" />
                                        </div>
                                        <h3 className="text-[20px] font-medium text-[#202124] m-0">Zero-Trust WASM Engine</h3>
                                    </div>
                                    <p className="text-[15px] text-[#5f6368] leading-relaxed m-0">
                                ...
                                <div className="bg-[#f8f9fa] p-6 rounded-[12px] border border-[#dadce0]">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="text-[20px] font-medium text-[#202124] m-0">Hybrid Cryptography Fallback</h3>
                                    </div>
                                    <p className="text-[15px] text-[#5f6368] leading-relaxed m-0">
                            ...
                            <div className="space-y-8">
                                <section>
                                    <h2 className="text-[24px] font-medium text-[#202124] mb-4 flex items-center gap-2">
                                        <Search className="w-6 h-6 text-[#5f6368]" /> Independent Audits
                                    </h2>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[#202124] mb-4 flex items-center gap-2">
                                        <Key className="w-6 h-6 text-[#5f6368]" /> Infrastructure Security
                                    </h2>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[#202124] mb-4 flex items-center gap-2">
                                        <FileWarning className="w-6 h-6 text-[#5f6368]" /> Vulnerability Disclosure
                                    </h2>
                                    <p className="text-[16px] text-[#5f6368] leading-relaxed">
                                        We welcome responsible disclosure of vulnerabilities from the security research community. If you believe you have found a security vulnerability in QuantaCipher's systems, APIs, or SDKs, please immediately report it to <a href="mailto:security@quantacipher.com" className="text-[#1a73e8] hover:underline">security@quantacipher.com</a>. We offer a bug bounty program for critical cryptographic or infrastructure findings.
                                    </p>
                                </section>
                            </div>
                        </div>
