            ...
            <main className="pt-24 pb-16">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-[800px] mb-16 border-b border-[#dadce0] pb-16">
                        ...
                        >
                            <h1 className="text-[48px] font-normal text-[#202124] mb-4">Contact Support</h1>
                    ...
                    {/* Contact Options */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[800px] mb-16 pb-16 border-b border-[#dadce0]">
                        <motion.div
                        ...
                        >
                            ...
                            <h3 className="text-[20px] font-medium text-[#202124] mb-2">Email Support</h3>
                            <p className="text-[14px] text-[#5f6368] mb-4">
                                Get help via email. We typically respond within 24 hours.
                            </p>
                            <a href="mailto:support@quantacipher.com" className="text-[#1a73e8] hover:underline text-[14px] font-medium">
                        ...
                        >
                            ...
                            <h3 className="text-[20px] font-medium text-[#202124] mb-2">Documentation</h3>
                            <p className="text-[14px] text-[#5f6368] mb-4">
                                Browse our guides and API documentation for quick answers.
                            </p>
                            <Link href="/documentation" className="text-[#1a73e8] hover:underline text-[14px] font-medium">
                                View Docs →
                            </Link>
                        </motion.div>
                    </div>
                    ...
                    >
                        <h2 className="text-[32px] font-normal text-[#202124] mb-8">Send us a message</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="relative group">
                                <textarea
                                    ...
                                    placeholder=" "
                                    rows={6}
                                    className="peer w-full px-4 pt-4 rounded-[4px] bg-[#f1f3f4] border-b-[1px] border-[#5f6368] focus:border-[#1a73e8] focus:border-b-[2px] outline-none transition-all placeholder-transparent resize-none"
                                />
                                <label className="absolute left-4 top-4 text-[#5f6368] text-[16px] transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-[16px] peer-focus:top-2 peer-focus:text-[12px] peer-focus:text-[#1a73e8] peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:text-[12px] pointer-events-none">
                                    Message
                                </label>
                            ...
                            <Button
                                type="submit"
                                className="bg-[#1a73e8] hover:bg-[#1967d2] text-white rounded-[4px] px-8 h-[48px] text-[16px] font-medium shadow-sm flex items-center gap-2"
                            >
