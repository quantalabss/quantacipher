        ...
        <div className="min-h-screen bg-[#FCFBF9] relative font-sans">
            ...
            <main className="pt-24 pb-16">
                <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-[48px] font-bold text-[#111111] mb-4 font-serif">Terms of Service</h1>
                        <p className="text-[14px] text-[#6B6356] mb-12 font-medium uppercase tracking-widest">Last updated: May 23, 2026</p>

                        <div className="prose prose-lg max-w-none">
                            <div className="space-y-8">
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">1. Agreement to Terms</h2>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">2. API Usage and Licenses</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed mb-4 font-medium">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">3. Subscriptions and Payments</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed mb-4 font-medium">
                                    ...
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed mb-4 font-medium">
                                        <strong className="text-[#111111]">Refunds:</strong> Please refer to our dedicated <a href="/refunds" className="text-[#8b7355] font-bold hover:underline">Cancellation and Refund Policy</a> for detailed information on subscription cancellations.
                                    </p>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">4. Service Availability</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed font-medium">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">5. Intellectual Property</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed font-medium">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">6. Limitation of Liability</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed font-medium">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">7. Termination</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed font-medium">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-bold text-[#111111] mb-4 font-serif">8. Contact Information</h2>
                                    <p className="text-[16px] text-[#6B6356] leading-relaxed font-medium">
                                        For legal inquiries regarding these Terms of Service, please contact us at: <a href="mailto:legal@quantacipher.com" className="text-[#8b7355] font-bold hover:underline">legal@quantacipher.com</a>.
                                    </p>
                                </section>
                            </div>
                        </div>
