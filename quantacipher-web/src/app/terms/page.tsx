        ...
        <div className="min-h-screen bg-[#0a0a0a]">
            ...
            <main className="pt-24 pb-16">
                <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-[48px] font-normal text-white mb-4">Terms of Service</h1>
                        ...
                        <div className="prose prose-lg max-w-none">
                            <div className="space-y-8">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-white mb-4">2. API Usage and Licenses</h2>
                                    <p className="text-[16px] text-gray-400 leading-relaxed mb-4">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-white mb-4">5. Intellectual Property</h2>
                                    <p className="text-[16px] text-gray-400 leading-relaxed">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-white mb-4">6. Limitation of Liability</h2>
                                    <p className="text-[16px] text-gray-400 leading-relaxed">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-white mb-4">7. Termination</h2>
                                    <p className="text-[16px] text-gray-400 leading-relaxed">
