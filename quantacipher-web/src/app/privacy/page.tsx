        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-24 pb-16">
                <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-[48px] font-normal text-[black] mb-4">Privacy Policy</h1>
                        <p className="text-[14px] text-[#6b7280] mb-12">Last updated: May 23, 2026</p>

                        <div className="prose prose-lg max-w-none">
                            <div className="space-y-8">
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">1. Introduction</h2>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">2. Information We Collect</h2>
                                    <p className="text-[16px] text-[#6b7280] leading-relaxed mb-4">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">3. How We Use Your Information</h2>
                                    <p className="text-[16px] text-[#6b7280] leading-relaxed mb-4">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">4. Data Security & Cryptography</h2>
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">5. Data Sharing and Disclosure</h2>
                                    <p className="text-[16px] text-[#6b7280] leading-relaxed mb-4">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">6. Your Data Rights</h2>
                                    <p className="text-[16px] text-[#6b7280] leading-relaxed">
                                ...
                                <section>
                                    <h2 className="text-[24px] font-medium text-[black] mb-4">7. Contact Us</h2>
                                    <p className="text-[16px] text-[#6b7280] leading-relaxed">
